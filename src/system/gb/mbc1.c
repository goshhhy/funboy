...
static unsigned char MBC1RomRead( busDevice_t *dev, unsigned long addr, int final ) {
    romInfo_t *rom;
...
static void MBC1RomWrite( busDevice_t *dev, unsigned long addr, unsigned char val, int final ) {
    romInfo_t *rom;
